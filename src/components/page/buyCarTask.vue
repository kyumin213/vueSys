			...
			<el-row>
				...
				<el-col :span="12" :xs="24">
					<el-form-item label="数量" class="disInline minWid" prop="OrderNum">
						<el-input v-model="taskForm.OrderNum" @blur="checkOrderNum" placeholder="请输入正整数"></el-input>
					</el-form-item>
				</el-col>
			</el-row>
			<div class="con">
      ...
      selectableRange: '00:00:00 - 23:59:00'
						...
						<el-col :span="10" :xs="24" :sm="10" :md="8" :lg="10">
							<el-form-item :prop="`OrderSchedule[${index}].Number`" :rules="{ required: true, message: '数量不能为空', trigger: 'change' }">
								<el-input type="text" v-model="item.Number" style="width: 60%;" @change="allOrderNum(index)" placeholder="请输入正整数"></el-input>
